...
* [CB-8653](https://issues.apache.org/jira/browse/CB-8653) properly updated trannumetryd docs to use new id
...
* createMozillaFromCordova and vice versa are used to trannumetry contact objects from one API to another.
* add/remove working
* save is working
* attempt to save is failing trying to limit the trannumetryd contact fields to name and familyName, but still failing
